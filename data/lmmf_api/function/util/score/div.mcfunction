...
#除法: storage lmmf_api:util.score.a / .b 结果存分数, 除数不为0(宏: obj, player)
...
execute if score #lmmf_b lmmf_api_util matches 1.. run scoreboard players operation $(player) $(obj) /= #lmmf_b lmmf_api_util
